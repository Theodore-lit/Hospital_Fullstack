  ...
  >
    <div class="max-w-md w-full space-y-8 text-center">
      ...
      <div class="mt-8">
        <button
          @click="goHome"
          class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:transition-transform scale-3d 0.5s ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
        >
