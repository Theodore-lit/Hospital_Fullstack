...
<template>
  ...
  <div class="min-h-screen px-10 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-12">
        ...
        <div class="bg-blue-50 rounded-xl p-6">
          <div class="flex items-center w-full justify-between">
            <div class="w-2/3">
              ...
              <p class="text-xs font-semibold uppercase text-blue-500 uppecrase transition-al">
                Patients
              </p>
              <!-- </div> -->
            </div>
      ...
      <div class="bg-white-50 rounded-2xl p-1 shadow-sm transition-transform hover:scale-[1.02]">
        <div class="bg-red-50 rounded-xl p-5">
          <div class="flex items-center justify-between">
            <div>
              <h3 class="text-slate-500 text-xs font-bold pt-1 uppercase tracking-wider mb-1">
                Urgence hospi
              </h3>
              <p class="text-slate-700 text-4xl font-black mb-1">
                {{}}
              </p>
              <span class="text-xs font-semibold uppercase text-red-500 uppecrase transition-al"
        ...
        <div class="bg-slate-50 rounded-xl p-6">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-xs font-semibold uppercase text-slate-600 uppecrase transition-al">
                Rooms dispo
              </p>
            </div>
        ...
        <div class="bg-green-50 rounded-xl p-6">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-xs font-semibold uppercase text-emerald-600 uppecrase transition-al">
                Rendez-vous
              </p>
            </div>
